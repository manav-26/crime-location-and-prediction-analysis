...
def webscrappingfun():
    ...
    df1=pd.read_csv(r'Source_code\static\assets\data\webscrappeddata.csv') #file is being read.
    ...
    df1.to_csv('Source_code\static\assets\data\webscrappeddata.csv', index=False, encoding='utf-8')
